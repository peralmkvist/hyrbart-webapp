...
export default function ProductSearchForm({locale,initialQuery='',category,initialFrom='',initialTo='',initialPlace='Danderyd',initialRadius='10',initiallyCollapsed=false}:Props){
 ...
 function resetSearch(){setQuery('');setFrom('');setTo('');setPlace('Danderyd');setRadius('10');setCalendarOpen(false);setExpanded(true);setSearchStarted(false);router.push(`/${locale}/produkter?edit=1`,{scroll:false})}
