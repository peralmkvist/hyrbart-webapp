...
export default function ProductSearchForm({locale,initialQuery='',category,initialFrom='',initialTo='',initialPlace='',initialRadius='10',initiallyCollapsed=false}:Props){
 ...
 function resetSearch(){setQuery('');setFrom('');setTo('');setPlace('');setRadius('10');setCalendarOpen(false);setExpanded(true);setSearchStarted(false);router.push(`/${locale}/produkter?edit=1`,{scroll:false})}
