...
export default function BottomNav() {
  ...
  const renterHome = !hostMode && appPath === `/${locale}`;
  ...
  return (
    <nav className={`liquidNav ${hostMode ? 'hostNav' : 'renterNav'} ${renterHome ? 'renterHomeNav' : ''}`} aria-label={hostMode ? hostLabels.aria : renterLabels.aria}>
