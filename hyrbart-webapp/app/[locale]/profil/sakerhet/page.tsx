...
export default async function SecurityPage({params}:{params:Promise<{locale:string}>}){
  ...
  const verified=Boolean(profile?.bankid_verified||profile?.identity_verification_status==='verified'); const pending=profile?.identity_verification_status==='pending'; const failed=profile?.identity_verification_status==='failed'||profile?.identity_verification_status==='revoked';
