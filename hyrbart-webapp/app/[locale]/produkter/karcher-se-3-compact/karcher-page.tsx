  ...
  return (
    <div className="pageShell detailPage karcherDetailPage">
      ...
      <div className="detailProductVisual productDetailPhotoWrap">
        <ProductVisual large imageSrc={product?.image} imageAlt="Kärcher SE 3 Compact med tillbehör" />
      ...
      <details className="specDropdown productDescriptionDropdown">
        <summary><InfoIcon /><span>{en ? 'Product description' : 'Produktbeskrivning'}</span><span className="specChevron" aria-hidden="true">⌄</span></summary>
        <div className="specBody productDescriptionBody"><p>{en ? 'Add the product description from Hygglo here.' : 'Lägg in produktbeskrivningen från Hygglo här.'}</p></div>
      </details>

      <details className="specDropdown">
        <summary><ListIcon /><span>{en ? 'Technical specifications' : 'Tekniska specifikationer'}</span><span className="specChevron" aria-hidden="true">⌄</span></summary>
