...
export default async function HostSettingsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const items = en ? [
    ...
    { title: 'Rental rules', copy: 'Set minimum and maximum rental time and buffer between bookings per listing.', href: `/topsecret/${locale}/vard/installningar/uthyrningsregler` },
    ...
    { title: 'Uthyrningsregler', copy: 'Ställ in minsta och längsta uthyrningstid samt buffert mellan bokningar per annons.', href: `/topsecret/${locale}/vard/installningar/uthyrningsregler` },
